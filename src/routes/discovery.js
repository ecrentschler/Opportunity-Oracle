...
const url = "https://api.search.brave.com/res/v1/web/search?count=10&q=" + encodeURIComponent(q);
...
for (const o of out) { if (o.url && !seen.has(o.url)) { seen.add(o.url); deduped.push(o); } }
